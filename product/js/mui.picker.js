...
(function($, window, document, undefined) {
	...
	Picker.prototype.init = function() {
		...
		if (isIos) {
			self.list.style.webkitTransformOrigin = "center center " + self.r / 40 + "rem";
		}
	};
	...
	Picker.prototype.calcElementItemPostion = function(andGenerateItms) {
		...
		self.elementItems.forEach(function(item) {
			...
			item.style.webkitTransformOrigin = "center center -" + self.r / 40 + "rem";
			item.style.webkitTransform = "translateZ(" + self.r / 40 + "rem) rotateX(" + (-self.endAngle) + "deg)";
			if (andGenerateItms) {
				var dataItem = {};
